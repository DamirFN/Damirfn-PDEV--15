...
from .filters import ProductFilter, NewsFilter, NewsFilterDate
...
class NewsList(ListView):
    ...
    def get_queryset(self):
        ...
        self.filtersetdate = NewsFilterDate(self.request.GET, queryset)

        return self.filterset.qs, self.filtersetdate.qs
    ...
    def get_context_data(self, **kwargs):
        ...
        # Добавляем в контекст объект фильтрации.
        context['filtersetdate'] = self.filtersetdate
