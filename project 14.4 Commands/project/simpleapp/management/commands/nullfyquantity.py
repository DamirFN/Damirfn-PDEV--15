...
from simpleapp.models import NewsPortal
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if answer == '1':  # в случае подтверждения действительно удаляем все товары
            NewsPortalCategory.objects.all().delete()
